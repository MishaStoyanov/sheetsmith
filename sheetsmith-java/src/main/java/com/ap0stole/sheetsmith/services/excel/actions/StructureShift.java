...
final class StructureShift {
     ...
     */
    static final int MAX_INSERT = 1_000;

    static final int EXCEL_MAX_ROWS = 1_048_576;
    ...
    static List<FormulaErrorScanner.CellError> formulaErrors(XSSFWorkbook workbook) {
     ...
     */
    static String report(String action, String what, int count, String where,
     ...
     */
    static String brokenFormulas(XSSFWorkbook workbook, List<FormulaErrorScanner.CellError> before) {
    ...
    static int row(Integer at, String key) {
        if (at == null) {
     ...
     */
    static int column(String at, String key) {
     ...
     * that takes one.
     */
    static int[] rowSpan(String range, Integer at, Integer count) {
    ...
    static int count(Integer requested, boolean inserting) {
        if (requested == null) {
            return 1;
        }
        if (requested < 1) {
    ...
    static int lastUsedColumn(XSSFSheet sheet) {
        int last = -1;
